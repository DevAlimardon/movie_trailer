...
import uz.infinityandro.moviestream.databinding.PageHorrorBinding
...
class PageHorror : Fragment(R.layout.page_horror) {
    private val binding by viewBinding(PageHorrorBinding::bind)
