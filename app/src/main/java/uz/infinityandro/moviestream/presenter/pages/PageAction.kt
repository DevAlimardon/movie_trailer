...
import uz.infinityandro.moviestream.databinding.PageActionBinding
...
class PageAction:Fragment(R.layout.page_action) {
    private val binding by viewBinding(PageActionBinding::bind)
