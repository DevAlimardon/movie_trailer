...
import uz.infinityandro.moviestream.databinding.PageRomanceBinding
...
class PageRomance : Fragment(R.layout.page_romance) {
    private val binding by viewBinding(PageRomanceBinding::bind)
