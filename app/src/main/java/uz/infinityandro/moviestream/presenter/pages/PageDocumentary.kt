...
import uz.infinityandro.moviestream.databinding.PageDocumentaryBinding
...
class PageDocumentary : Fragment(R.layout.page_documentary) {
    private val binding by viewBinding(PageDocumentaryBinding::bind)
