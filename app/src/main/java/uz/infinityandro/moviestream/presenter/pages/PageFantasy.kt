...
import uz.infinityandro.moviestream.databinding.PageFantasyBinding
...
class PageFantasy : Fragment(R.layout.page_fantasy) {
    private val binding by viewBinding(PageFantasyBinding::bind)
